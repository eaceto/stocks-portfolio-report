  ...
  return (
    <main className="wrap legal">
      ...
      <section className="legal-section">
        ...
        <p>
          <strong>IRPF Cartera no envía nada a ningún servidor.</strong> El archivo que subes se lee
          y procesa <em>localmente</em> en el navegador (en un Web Worker, con <em>fallback</em> al
          hilo principal). La aplicación se distribuye como un export estático: no hay backend
          capaz de recibir, almacenar o reenviar tus datos.
        </p>
        <ul>
          <li>
