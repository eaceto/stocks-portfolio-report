...
export function templateToBytes(): Uint8Array<ArrayBuffer> {
  // ArrayBuffer-backed (see workbookToBytes in export-xlsx.ts for the rationale).
  return XLSX.write(buildTemplateWorkbook(), {
    type: "array",
    bookType: "xlsx",
